...
![ColorCAL 3 device menu]({{ '/assets/images/colorcal/colorcal-device-menu.png' | relative_url }})
...
![ColorCAL 3 measurement output]({{ '/assets/images/colorcal/colorcal-measurement-output.png' | relative_url }})
